...
ActiveRecord::Schema.define(version: 2020_01_25_060543) do
  ...
  create_table "books_categories", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "book_id"
